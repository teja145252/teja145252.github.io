...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectDetails = {
        Sleep:"<p>The sleep analysis dashboard visualizes sleep health and its affecting factors. I created this dashboard using Power BI. I collected the sleep health and lifestyle dataset from Kaggle, cleaned and transformed it, and divided blood pressure into systolic and diastolic columns. I then categorized it using DAX (SWITCH). I created eight DAX measures for different metrics and visualized general sleep patterns, sleep disorder analysis, health metrics comparison, occupation impact, and more. To view the dashboard, go back and scroll down.</p>",
